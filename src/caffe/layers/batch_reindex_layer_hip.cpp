...
void BatchReindexLayer<Dtype>::Forward_gpu(const vector<Blob<Dtype>*>& bottom,
  ...
  hipLaunchKernel(HIP_KERNEL_NAME(BRForward), dim3(CAFFE_GET_BLOCKS(threads)), dim3(CAFFE_HIP_NUM_THREADS), 0, 0, top0_count, bot0_count / bot0_shape, bot0_gpu_data, bot1_gpu_data, top0_mut_gpu_data);
#endif
